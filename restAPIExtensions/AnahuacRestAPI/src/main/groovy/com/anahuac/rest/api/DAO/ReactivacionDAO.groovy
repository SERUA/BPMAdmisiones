...
class ReactivacionDAO {
	...
	public Result reactivarAspiranteV2(Integer parameterP, Integer parameterC, String jsonData, RestAPIContext context) {
		Result resultado = new Result();
		String errorLog = "";
		Boolean closeCon = false;
		Boolean autoCommit = false;
	...
	public Result nuevoCasoSolicitudV2(String jsonData,RestAPIContext context) {
		Result resultado = new Result();
		Long caseId = 0L;
		String errorLog = "";
		Boolean closeCon = false;
		try {
			...
			Result resultado2 = new Result();
			resultado2 = copiarArchivosV2(Long.valueOf(object.caseid,),caseId,context)
			if(resultado2.isSuccess()) {
				errorLog+= "Se subieron archivos"
			}else {
				errorLog+= "Errorsubieron archivos:"+resultado2
	...
	public Result validarAspiranteV2(Long caseidOrigen,Long caseid,RestAPIContext context,Map<String, Serializable> contract) {
		Result resultado = new Result();
		List<CatRegistro> lstCatRegistro = new ArrayList<CatRegistro>();
		CatRegistro objCatRegistro = new CatRegistro();
		String errorLog ="";
	...
	public Result updateDatosSolicitudV2(String caseIdOrigen,String caseIdDestino,RestAPIContext context) {
		Result resultado = new Result();
		Boolean closeCon = false;
		String errorLog = "";
	...
	public Result copiarArchivosV2(Long caseidOrigen,Long caseid,RestAPIContext context) {
		Result resultado = new Result();
		String errorLog ="";
		Boolean closeCon = false;
		try {
	...
	public Result updateDatosSolicitudV3(String caseIdOrigen,String caseIdDestino,RestAPIContext context) {
		Result resultado = new Result();
		Boolean closeCon = false;
		String errorLog = "";
		try {
