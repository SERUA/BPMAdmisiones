...
class SecurityFilter {
	...
	public Boolean bonitaRolFilter(RestAPIContext context, String roleName) {
		...
		uMemberships.each{
			it ->
			if(it.roleName.toLowerCase().equals(roleName.toLowerCase()) || it.roleName.equals("ADMINISTRADOR") || it.roleName.equals("TI SERUA") || it.roleName.equals("SERUA") || it.roleName.equals("TI CAMPUS")) {
				valid=true
			}
		}
