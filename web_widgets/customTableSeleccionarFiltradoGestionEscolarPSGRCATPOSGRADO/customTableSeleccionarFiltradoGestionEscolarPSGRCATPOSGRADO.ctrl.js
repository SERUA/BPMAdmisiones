function PbTableCtrl($scope, $http, $location, $log, $window, localStorageService, modalService, blockUI) {
    ...
    function doRequestDelete(method, url, params) {
        ...
        datos.lstCatGestionEscolarInput[0].propedeuticos = [];
        var req = {
            method: method,
            url: url,
            data: datos,
    ...
    $scope.deleteCatalogo = function (dataToDelete) {
        ...
        .then(function (response) {
            ...
            // Llama a la función doRequest para actualizar la vista u otras acciones necesarias
            return doRequest('POST', $scope.properties.urlPost, /* opcional: params */);
        })
        .catch(function (error) {
