function PbButtonCtrl($scope, $http, $location, $log, $window, localStorageService, modalService) {
    ...
    function validar(){
        ...
        if(!$scope.properties.valueToAdd.nombre_empresa){
            ...
            valido = false;
        } else if(!$scope.properties.valueToAdd.tipo_empleado){
            ...
            valido = false;
        } else if(!$scope.properties.valueToAdd.desc_responsabilidad){
            mensaje = "El campo 'Descripción de responsabilidades' no debe ir vacío";
            valido = false;
        }
