function PbButtonCtrl($scope, $http, $location, $log, $window, localStorageService, modalService) {
	...
	if($scope.properties.dataToChange2.id != undefined){
		...
		if(!$scope.properties.dataToChange2.urlAutorDatos ){
			swal("¡Falto capurar informacion en!", "Url Autor Datos", "warning");
		}
		if(!$scope.properties.dataToChange2.urlDatosVeridicos ){
			swal("¡Falto capurar informacion en!", "Url Datos verídicos", "warning");
		}
		   if(!$scope.properties.dataToChange2.urlAvisoPrivacidad ){
			   swal("¡Falto capurar informacion en!", "Url Aviso Privacidad", "warning");
		   }
		   if(!$scope.properties.dataToChange2.grupoBonita ){
				   swal("¡Falto capurar informacion en!", "Grupo relacionado", "warning");
		   }
		   ...
		   if(!$scope.properties.dataToChange2.id){
				swal("¡Falto capurar informacion en!", "Id", "warning");
		   }
	   }
