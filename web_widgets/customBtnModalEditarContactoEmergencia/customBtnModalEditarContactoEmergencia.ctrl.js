    ...
    this.action = function action() {
      if ($scope.properties.action === 'Remove from collection') {
        ...
        openModal($scope.properties.modalId);
          ...
          if ($scope.properties.contactoJson.telefono !== $scope.properties.jsonModificarContacto.telefono) {
              $scope.properties.contactoJson.telefono = $scope.properties.jsonModificarContacto.telefono
          }
