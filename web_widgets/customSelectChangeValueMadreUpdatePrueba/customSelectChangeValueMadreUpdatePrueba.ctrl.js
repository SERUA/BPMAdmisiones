function PbSelectCtrl($scope, $parse, $log, widgetNameFactory, $timeout, $window, $element) {
    ...
    $scope.cleandata = function() {
        ...
        if ($scope.properties.objMadre.catPais.descripcion !== "México") {
            $scope.properties.objMadre.catEstado = null;
            $scope.properties.objMadre.ciudad = "";
            $scope.properties.objMadre.delegacionMunicipio = "";
            $scope.properties.objMadre.colonia = "";
            $scope.properties.objMadre.codigoPostal = "";
            ...
            $scope.properties.objMadre.colonia = "";
            $scope.properties.objMadre.codigoPostal = "";
            $scope.properties.objMadre.estadoExtranjero = "";
            $scope.properties.datosCP = undefined;
            $scope.properties.haveCiudad = false;
        }
