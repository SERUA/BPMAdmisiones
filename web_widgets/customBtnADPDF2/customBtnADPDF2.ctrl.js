function PbButtonCtrl($scope, modalService, $http, blockUI, $q, $filter) {
    ...
    $scope.generatePDF = function() {
        ...
        if ($scope.properties.PDFobjMadre.catPais != null) {
            ...
            doc.text(($scope.properties.PDFobjMadre?.catEstado?.descripcion == null || $scope.properties.PDFobjMadre?.catEstado?.descripcion == "" ? $scope.properties.PDFobjMadre?.estadoExtranjero : $scope.properties .PDFobjMadre?.descripcion), respuestasSegundaFila, (height / 2) + 23);
