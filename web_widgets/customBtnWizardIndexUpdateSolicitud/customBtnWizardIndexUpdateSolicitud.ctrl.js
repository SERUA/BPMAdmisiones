    ...
    $scope.action = function() {
        ...
        if ($scope.properties.selectedIndex === 0) {
            ...
            if ($scope.properties.catSolicitudDeAdmision.catCampus.persistenceId_string === "") {
                swal($filter('translate')("¡Campus!"), $filter('translate')("Debes seleccionar un campus donde cursará sus estudios"), "warning");
                ...
                if ($scope.properties.catSolicitudDeAdmision.catPropedeutico === null) {
                    ...
                    if ($scope.properties.catSolicitudDeAdmision.catPeriodo === null) {
                        swal($filter('translate')("¡Período!"), $filter('translate')("Debes seleccionar un período donde cursará sus estudios"), "warning");
            ...
            /* else if ($scope.properties.catSolicitudDeAdmision.apellidoMaterno === "") {
                ...
                if ($scope.properties.catSolicitudDeAdmision.catPropedeutico === null) {
                    swal($filter('translate')("Curso propedéutico!"), $filter('translate')("Por favor selecciona un curso propedéutico"), "warning");
                } else {
            ...
            console.log("validar 2 con validacion de ulrs");
            if ($scope.properties.action === "Anterior" && $scope.properties.selectedIndex > 0) {
                $scope.properties.selectedIndex--;
            ...
            if (!$scope.faltacampo) {
                ...
                /*else if ($scope.properties.catSolicitudDeAdmision.calle2 === "") {
                    ...
                    } else if ((isNaN($scope.properties.catSolicitudDeAdmision.promedioGeneral)||$scope.properties.catSolicitudDeAdmision.promedioGeneral=="0") && $scope.properties.datosPreparatoria.paisBachillerato === 'México') {
                        swal($filter('translate')("¡Promedio!"), $filter('translate')("Debes agregar el promedio que obtuvo en tu preparatoria"), "warning");
                    } else if ($scope.properties.catSolicitudDeAdmision.promedioGeneral === "" ||$scope.properties.catSolicitudDeAdmision.promedioGeneral=="0" || $scope.properties.catSolicitudDeAdmision.promedioGeneral === null) {
                        swal($filter('translate')("¡Promedio!"), $filter('translate')("Debes agregar el promedio que obtuvo en tu preparatoria"), "warning");
                    } else {
                        if ($scope.properties.action === "Anterior" && $scope.properties.selectedIndex > 0) {
                            $scope.properties.selectedIndex--;
                            ...
                            if (!$scope.fallo) {
                                if ($scope.properties.catSolicitudDeAdmision.tienePAA) {
                                    if ($scope.properties.catSolicitudDeAdmision.resultadoPAA === 0 || $scope.properties.catSolicitudDeAdmision.resultadoPAA === "" || $scope.properties.catSolicitudDeAdmision.resultadoPAA === null || $scope.properties.catSolicitudDeAdmision.resultadoPAA === undefined) {
                                        $scope.fallo = true;
                                        swal($filter('translate')("¡Resultado (PAA) del Examen Collage Board!"), $filter('translate')("Tu puntuacion debe ser mayor a cero"), "warning");
                                    ...
                                    } // Aqui termina el else mayor a 1
                                    /*if ($scope.properties.catSolicitudDeAdmision.resultadoPAA === 0 || $scope.properties.catSolicitudDeAdmision.resultadoPAA === "" || $scope.properties.catSolicitudDeAdmision.resultadoPAA === null || $scope.properties.catSolicitudDeAdmision.resultadoPAA === undefined) {
                                        $scope.fallo = true;
                                        swal($filter('translate')("¡Resultado (PAA) del Examen Collage Board!"), $filter('translate')("Tu puntuacion debe ser mayor a cero"), "warning");
                                    } else if ($scope.properties.catSolicitudDeAdmision.resultadoPAA > 1) {
                    ...
                    if ($scope.properties.action === "Anterior" && $scope.properties.selectedIndex > 0) {
                        ...
                        if (!$scope.fallo) {
                            if ($scope.properties.catSolicitudDeAdmision.tienePAA) {
                                if ($scope.properties.catSolicitudDeAdmision.resultadoPAA === 0 || $scope.properties.catSolicitudDeAdmision.resultadoPAA === "" || $scope.properties.catSolicitudDeAdmision.resultadoPAA === null || $scope.properties.catSolicitudDeAdmision.resultadoPAA === undefined) {
                                    $scope.fallo = true;
                                    swal($filter('translate')("¡Resultado (PAA) del Examen Collage Board!"), $filter('translate')("Tu puntuación debe ser mayor a cero"), "warning");
                                } else if ($scope.properties.catSolicitudDeAdmision.resultadoPAA > 1) {
                                    if (JSON.stringify($scope.properties.collageBoard) === "{}") {
                                        $scope.fallo = true;
                                        swal($filter('translate')("¡Constancia Collage Board!"), $filter('translate')("Debes agregar la constancia del resultado PAA como viene emitida por el College Board."), "warning");
                                    } else {
                                        if ($scope.properties.catSolicitudDeAdmision.urlResultadoPAA === null || $scope.properties.catSolicitudDeAdmision.urlResultadoPAA === "") {
                                            if ($scope.properties.collageBoardarchivo.length > 0) {
                                                var auxData = null;
            ...
            if ($scope.properties.action === "Anterior" && $scope.properties.selectedIndex > 0) {
                ...
                swal($filter('translate')("¡Nombre del padre!"), $filter('translate')("Debes agregar el nombre del padre"), "warning");
