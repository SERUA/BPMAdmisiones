    ...
    this.action = function action() {
        ...
        if ($scope.properties.action === 'Remove from collection') {
            ...
            if($scope.properties.editarSec1 == false){
                ...
                $scope.properties.JSONUsuarioRegistrado.cattitulo = parseInt($scope.properties.objPadre.catTitulo.persistenceId);
                ...
                $scope.properties.JSONUsuarioRegistrado.categresoanahuac = $scope.properties.objPadre.catEgresoAnahuac !== undefined ? parseInt($scope.properties.objPadre.catEgresoAnahuac.persistenceId) : null;
                $scope.properties.JSONUsuarioRegistrado.cattrabaja = $scope.properties.objPadre.catTrabaja !== undefined ? parseInt($scope.properties.objPadre.catTrabaja.persistenceId) : null;
                $scope.properties.JSONUsuarioRegistrado.catcampus = $scope.properties.objPadre.catCampus !== undefined && $scope.properties.objPadre.catCampus !== null ? parseInt($scope.properties.objPadre.catCampusEgreso.persistenceId) : null;
                ...
                $scope.properties.JSONUsuarioRegistrado.catescolaridad = $scope.properties.objPadre.catEscolaridad !== undefined ? parseInt($scope.properties.objPadre.catEscolaridad.persistenceId) : null;
                ...
                $scope.properties.JSONUsuarioRegistrado.catpais = $scope.properties.objPadre.catPais !== undefined ? parseInt($scope.properties.objPadre.catPais.persistenceId) : null;
                ...
                $scope.properties.JSONUsuarioRegistrado.catestado = $scope.properties.objPadre.catEstado !== undefined ? parseInt($scope.properties.objPadre.catEstado.persistenceId) : null;
