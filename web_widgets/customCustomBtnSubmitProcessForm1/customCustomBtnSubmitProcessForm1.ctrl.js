  ...
  this.action = function action() {
    if ($scope.properties.action === 'Remove from collection') {
      ...
      closeModal($scope.properties.closeOnSuccess);
        ...
        /*
            return {
                "nombreusaurio": $data.formInput.catRegistroInput.NombreUsuario,
                "nombre": $data.formInput.catRegistroInput.PrimerNombre + " " + $data.formInput.catRegistroInput.SegundoNombre,
                "apellido": $data.formInput.catRegistroInput.ApellidoPaterno+ " "+$data.formInput.catRegistroInput.ApellidoMaterno,
                "password": $data.formInput.catRegistroInput.Password
            }
        */
