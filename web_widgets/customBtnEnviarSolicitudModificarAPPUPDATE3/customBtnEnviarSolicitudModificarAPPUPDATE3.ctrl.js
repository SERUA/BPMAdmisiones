function PbButtonCtrl($scope, $http, $location, $log, $window, localStorageService, modalService, blockUI) {
  ...
  function unassignTask() {
      var id;
      id = angular.copy($scope.properties.taskId)
      if (id) {
          ...
          .error(function(data, status) {
              ...
              swal("No se puede validar.","Esta tarea no se puede ejecutar debido a que un usuario ya la ejecutó.", "warning");
  ...
  function assignTask2() {
      var id;
      id = angular.copy($scope.properties.userId)
      if (id) {
